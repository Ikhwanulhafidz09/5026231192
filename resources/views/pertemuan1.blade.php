...
<body>
    ...
    <nav>
        ...
        <a href="https://www.google.co.id/" target="_blank">Google</a> |
        <a href="#">Halaman ini</a>
    </nav>

    <h1 style="color: #1a008d;">Bantu Adaptasi Mahasiswa Baru, ITS Gelar Mentoring Agama Islam</h1>
    <p><i>Oleh : itsash / 18 / Source : ITS Online</i></p>

    <p style="font-size: small;">
        <img src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_084851-1024x576.jpg" alt="kuliah umum mentoring" width="100%">
        <br>
    ...
    <p style="font-size: small;">
        <img src="image/pertemuan-1/dosen_agama.jpg" alt="dosen agama" width="100%">
        <br>
    ...
    <p style="font-size: small;">
        <img src="https://www.its.ac.id/news/wp-content/uploads/sites/2/2025/02/IMG_20250223_111422-1024x576.jpg" alt="ba maba" width="100%">
        <br>
        Maba ITS dalam kegiatan Mentoring Agama Islam Semester Genap 2024/2025 di Masjid Manarul Ilmi ITS
    </p>

    <p>Menilik terlaksananya mentoring, ia berharap program ini bisa terus berkembang dan lebih terstruktur ke depannya. Mentoring ini bukan sekadar formalitas, tetapi wadah untuk memperbaiki diri dan menjadi pribadi muslim yang lebih baik. Mahasiswa yang tidak hanya cerdas secara intelektual, tetapi juga memiliki pondasi moral dan spiritual yang kuat.</p>
